...
public class Exercise2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tombolBicara2 = (Button) findViewById(R.id.tombolBicara2);

        tombolBicara2.setOnClickListener(new View.OnClickListener() {
            @Override
                    ...
                    builder.setMessage("Apakah Anda Yakin dengan Jawaban Anda?")
                            ...
                            .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    Intent intent = new Intent(Exercise2Activity.this,MainActivity.class);
                            ...
                            .setNegativeButton("No", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    Intent intent = new Intent(Exercise2Activity.this,ExerciseActivity.class);
                                    startActivity(intent);
                                    finish();
                                }
                            });
